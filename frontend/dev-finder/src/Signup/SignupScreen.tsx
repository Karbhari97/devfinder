...
function SignupScreen({ onSwitch }:any) {
  ...
  return (
    <div className="auth-card wide">
      <div className="logo" onClick={()=>{navigate('/')}}>dev<span>//</span>finder <div className="logo-dot" /></div>
      <h1 className="auth-title">Join the <em>network.</em></h1>
      <p className="auth-sub">Create your profile and start matching with developers who share your vision.</p>
      ...
      <div className="divider" style={{ marginTop: 20 }}><span>Already have an account?</span></div>
